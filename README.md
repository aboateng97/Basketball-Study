# Basketball Study
We propose to examine the relationship between travel distance and game performance in the NBA, specifi- cally whether the number of miles an away team travels affects the point differential (away team score minus home team score). This research question has practical implications for multiple stakeholders: coaches and team administrators can use these insights for scheduling and travel logistics; players and athletic trainers can better prepare for the physical demands of travel; and sports bettors can make more informed predic- tions. While previous research, notably Deddens and Steenland (1997),1 found few consistent effects of travel distance or direction in their analysis of regular season NBA games, we aim to revisit this question with a more comprehensive dataset spanning seven decades. Additionally, we will explore related questions such as whether specific home team cities or game attendance levels moderate the relationship between travel and performance.

To answer this research question, we will construct a series of linear regression models using historical NBA game data from 1947 to present, sourced from Kaggle’s ”NBA Dataset - Box Scores & Stats”2. Each individual NBA game serves as the unit of observation. Our dependent variable is the point differential (away team score minus home team score), calculated from the awayScore and homeScore variables. The primary independent variable is travel distance, which we will compute as the geodesic distance (great-circle distance) between the homeTeamCity and awayTeamCity. We will employ a progressive modeling approach: Model 1 will examine the baseline relationship between travel distance and point differential; Model 2 will add fixed effects for home team city to control for venue-specific advantages; and Model 3 will incorporate the attendance variable to test whether crowd size influences the relationship. This linear regression approach is appropriate given our continuous dependent variable and our interest in estimating the marginal effect of travel distance on game outcomes.
